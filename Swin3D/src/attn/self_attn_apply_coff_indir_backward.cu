    ...
    int64_t pos_bias_method)
{
    ...
    c10::cuda::CUDAGuard guard(updated_value_grads.device());
    ...
    AT_DISPATCH_FLOATING_TYPES_AND_HALF(value_feats.scalar_type(), "self_attn_apply_coff_cuda_backward_kernel", ([&] {
